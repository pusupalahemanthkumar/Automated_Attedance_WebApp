...
const DashboardPage = ({ history }) => {
  ...
  useEffect(() => {
    ...
    if (userInfo.role === "student") {
      dispatch(getAttendance({ rollNumber: userInfo.rollNumber }));
    } else {
      dispatch(getAttendance({ subject: userInfo.subject }));
    }
  ...
  const updateAttendance = async (studData) => {
    ...
    await axios.post(URL, studData, config);
    if (userInfo.role === "student") {
      dispatch(
        getAttendance({
    ...
    <>
      ...
      <div className="dashboard-main-container">
        ...
        <div className="dashboard-attendance-logs-container">
          ...
          <div className="dashboard-attendance-logs-table-container">{UI}</div>
        </div>
      </div>
