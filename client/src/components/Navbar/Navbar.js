...
const Navbar = () => {
  ...
  const [mobileViewNavClass, setMobileViewNavClass] =
    useState("mobile-nav-links");
  ...
  return (
    <>
      <nav className="navbar">
        <div className="logo">
          <h1>
            <span className="primary-color-1">
              {" "}
              <i className="fas fa-calendar-check secondary-color-2"></i>{" "}
              Attendance App
            </span>
          </h1>
        </div>
